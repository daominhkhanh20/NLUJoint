...
def parse_args():
    ...
    parser.add_argument(
        "--input_file",
        default="BKAI/word-level/private_test/seq.in",
        type=str,
        help="Input file for prediction",
    )
    parser.add_argument(
        "--output_file", default="output/results.csv", type=str, help="Output file for prediction"
    )
    parser.add_argument(
        "--model_dir",
        default="./trained_models/filtering_model",
        type=str,
    ...
    parser.add_argument(
        "--use_rule_based", default=True, action="store_true", help="Rule for modify label"
    )
...
def convert_input_file_to_tensor_dataset(
    ...
    dataset = TensorDataset(
        all_input_ids, all_attention_mask, all_token_type_ids, all_slot_label_mask, all_real_len
    )
